...
#             branch_code = 'SBTB'
#             auto_increament_value = 1
            
#             if new_branch.branch_is_active:
#                 auto_increament_value +=  1
#                 print(auto_increament_value)
#                 from django.contrib.auth.hashers import make_password     
#                 branch_user = User.objects.create(username=f'{branch_code}{auto_increament_value}',password=make_password(
#                               password_genrator()),email=new_branch.EmailID,is_staff=True)
...
#                 )
#                 new_branch.user.username = request.user.username
#                 new_branch.save()
